...
# Club情報作成
Club.create( yarn_count_string: 'W', yarn_count_number: 1, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 10, largo: 45.75, weight: 316, balance_string: 'D', balance_number: '4', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'U', yarn_count_number: 3, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 15, largo: 41.00, weight: 348, balance_string: 'D', balance_number: '0', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'U', yarn_count_number: 5, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 40.50, weight: 415, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'I', yarn_count_number: 5, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 37.75, weight: 428, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'I', yarn_count_number: 6, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 37.25, weight: 435, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'I', yarn_count_number: 7, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 36.75, weight: 442, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'I', yarn_count_number: 8, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 36.25, weight: 449, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'I', yarn_count_number: 9, detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 35.75, weight: 456, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'PW', detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 25, largo: 35.25, weight: 465, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
Club.create( yarn_count_string: 'SW', detail: 'MAVRIK 440ツアーバージョン（9°、グラファイトデザイン Tour AD XC-7TX）',loft: 58, largo: 34.5, weight: 483, balance_string: 'D', balance_number: '3', frequency: 250, user_id: 1)
